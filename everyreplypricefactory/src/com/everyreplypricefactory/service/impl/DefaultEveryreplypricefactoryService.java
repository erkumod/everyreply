...
public class DefaultEveryreplypricefactoryService implements EveryreplypricefactoryService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultEveryreplypricefactoryService.class);
	...
	{
		return DefaultEveryreplypricefactoryService.class.getResourceAsStream("/everyreplypricefactory/sap-hybris-platform.png");
	}
