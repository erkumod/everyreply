 ...
 */
package com.everyreply.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(EveryreplyFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(EveryreplyFulfilmentProcessConstants.PARENT_PROCESS);
