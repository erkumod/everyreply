...
public class AssistedServiceComponentController extends AbstractController
{
	...
	{
		List<AutoSuggestionCustomerData> autoSuggestionCustomerDataList = new ArrayList<>();
		try
		{
			...
			if (CollectionUtils.isNotEmpty(customers))
			{
				for (final CustomerData customer : customers)
				{
					...
					if (CollectionUtils.isNotEmpty(carts))
					{
						...
						for (final CartData cart : carts)
						{
							cartCodes.add(cart.getCode());
						}
	...
	protected void populateCustomerJSON(final CustomerModel customer, AutoSuggestionCustomerData autoSuggestionCustomerData) throws UnsupportedEncodingException
	{
