...
public class MerchantCallbackController
{
	...
	@ApiOperation(value = "Verify the decision of the Merchant", notes = "Verifies the decision of the merchant. \n\nNote, "
	...
	@ApiBaseSiteIdParam
	public void handleMerchantCallback(@ApiIgnore final HttpServletRequest request)
	{
	...
	@ResponseStatus(value = HttpStatus.OK)
	@ApiOperation(value = "Verify the decision of the Merchant for a cart", notes = "Verifies the decision of the merchant for a specified cart, and stores information of the PaymentSubscriptionResult "
