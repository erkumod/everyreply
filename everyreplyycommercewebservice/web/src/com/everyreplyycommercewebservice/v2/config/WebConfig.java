 ...
 */
package com.everyreplyycommercewebservice.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import com.everyreplyycommercewebservice.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "everyreplyycommercewebservice.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "everyreplyycommercewebservice.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "everyreplyycommercewebservice.oauth2.tokenUrl";

	private static final String DESC = "everyreplyycommercewebservice.v2.description";
	private static final String TITLE = "everyreplyycommercewebservice.v2.title";
	private static final String VERSION = "everyreplyycommercewebservice.v2.version";
