 ...
 */
package com.everyreply.cockpits.productcockpit.editor;
...
public class ExternalTaxesSectionRenderer implements SectionRenderer
{
	...
	protected void constructHbox(final SectionPanel panel, final Div mainCnt,
		...
		if (secConfig != null)
		{
			...
			final Label rowLabel = new Label(Labels.getLabel("everyreplycockpits.product.externalTaxes"));
			rowLabel.setTooltiptext(Labels.getLabel("everyreplycockpits.product.externalTaxes"));
