 ...
 */
package com.everyreply.cockpits.setup;
...
import com.everyreply.cockpits.constants.EveryreplyCockpitsConstants;
 ...
 */
@SystemSetup(extension = EveryreplyCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(EveryreplyCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(EveryreplyCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						EveryreplyCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/everyreplycockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
