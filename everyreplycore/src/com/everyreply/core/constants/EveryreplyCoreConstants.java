...
/**
 * Global class for all EveryreplyCore constants. You can add global constants for your extension into this class.
 */
public final class EveryreplyCoreConstants extends GeneratedEveryreplyCoreConstants
{
	public static final String EXTENSIONNAME = "everyreplycore";


	private EveryreplyCoreConstants()
	{
		//empty
	}
